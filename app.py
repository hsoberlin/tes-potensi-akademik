...
soal_paket_2 = [
    ...
    # --- DERET LOGIKA TINGKAT DUA (16-20) ---
    ...
    # --- PERBANDINGAN & SOAL CERITA KOMPLEKS (21-30) ---
...
if 'pilihan_paket' not in st.session_state:
    st.session_state.pilihan_paket = "Paket 1 (Dasar)"
...
# ==========================================
    ...
    if not st.session_state.telah_submit:
        ...
        if submit_button:
            ...
            skor_akhir = (benar / len(soal_aktif)) * 100
